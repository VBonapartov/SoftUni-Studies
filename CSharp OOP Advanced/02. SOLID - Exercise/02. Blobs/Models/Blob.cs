...
public class Blob : IBlob
{
    ...
    protected IAttackFactory AttackFactory
    {
        ...
        private set
        {
            this.attackFactory = value ?? throw new ArgumentNullException(nameof(value), "A blob's attack factory cannot be null.");
        }
    }
    ...
    protected IBehaviorFactory BehaviorFactory
    {
        ...
        private set
        {
            this.behaviorFactory = value ?? throw new ArgumentNullException(nameof(value), "A blob's behavior factory cannot be null.");
        }
    }
